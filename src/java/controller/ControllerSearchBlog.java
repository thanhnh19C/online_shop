 ...
 * @author admin
 */
@WebServlet(name = "ControllerSearchBlog", urlPatterns = {"/searchblog"})
public class ControllerSearchBlog extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int count = dao.getTotalSearchBlog(txtSearch);
        int endPage = count / 6;
        if (count % 6 != 0) {
            endPage++;
        }
        ...
        List<Blog> listBS = dao.searchByName(txtSearch, index);
